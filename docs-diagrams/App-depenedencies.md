...
The following code represents the npm-packages and their versions that should be installed
...
The following code is the npm-packages and their versions required in case the development on the application is required 
...
- AWS Elastic beanstalk hosting the Backend-api should have a these env variables
